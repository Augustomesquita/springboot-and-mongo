package mesquita.springframework.security.controller;

import mesquita.springframework.security.dto.JAuthenticationDTO;
import mesquita.springframework.security.dto.JTokenDTO;
import mesquita.springframework.security.utils.JJwtUtil;
...
import mesquita.springframework.security.dto.JUserAndTokenDTO;
import mesquita.springframework.utils.JConvertToDtoUtil;
import mesquita.springframework.utils.JResponseUtil;
...
public class JAuthenticationController {
    ...
    public ResponseEntity<JResponseUtil<JUserAndTokenDTO>> createTokenJwt(
        ...
        Optional<User> validUser = userService.findByEmailAndPassword(authenticationDTO.getEmail(), authenticationDTO.getPassword());
        if (validUser.isPresent()) {
            ...
            User userJustCreated = userService.save(authenticationDTO.getName(), authenticationDTO.getEmail(), authenticationDTO.getPassword(), authenticationDTO.getPhotoUrl());
    ...
    private void generateToken(UserDetails userDetails, User validUser, JResponseUtil<JUserAndTokenDTO> response) {
